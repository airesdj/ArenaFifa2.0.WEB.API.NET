...
begin      
	...
	UNION ALL
	SELECT G.ID_GOLEADOR, T.ID_TIME, T.NM_TIME, T.DS_Tipo, G.NM_GOLEADOR as NM_GOLEADOR_COMPLETO, G.NM_GOLEADOR, J.QT_GOLS, 'Home' as TP_TIME 
	FROM TB_GOLEADOR G, TB_GOLEADOR_JOGO J, TB_TIME T
	WHERE J.ID_TABELA_JOGO = pIdJogo AND J.ID_CAMPEONATO = pIdCamp 
	AND G.ID_GOLEADOR = 0 AND G.ID_TIME = 0 AND J.ID_TIME = _idTimeHome
	AND J.ID_GOLEADOR = G.ID_GOLEADOR AND J.ID_TIME = T.ID_TIME
	UNION ALL
	...
	AND J.ID_GOLEADOR = G.ID_GOLEADOR AND J.ID_TIME = G.ID_TIME AND G.ID_TIME = T.ID_TIME AND J.ID_TIME = T.ID_TIME
	UNION ALL
	SELECT G.ID_GOLEADOR, T.ID_TIME, T.NM_TIME, T.DS_Tipo, G.NM_GOLEADOR as NM_GOLEADOR_COMPLETO, G.NM_GOLEADOR, J.QT_GOLS, 'Away' as TP_TIME 
	FROM TB_GOLEADOR G, TB_GOLEADOR_JOGO J, TB_TIME T
	WHERE J.ID_TABELA_JOGO = pIdJogo AND J.ID_CAMPEONATO = pIdCamp 
