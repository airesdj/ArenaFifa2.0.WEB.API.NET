...
CREATE TABLE `arenafifadb`.`TB_TEMP_MATCHES_DETAILS_BY_TEAM` (
  ...
  `ID_TABELA_JOGO_NEXT_MATCH` INTEGER NULL DEFAULT 0, 
  ...
  `ID_TABELA_JOGO_PREV_MATCH` INTEGER NULL DEFAULT 0, 
...
Begin
	...
	get_tabela: LOOP
		...
		INSERT INTO TB_TEMP_MATCHES_DETAILS_BY_TEAM (ID_USUARIO, ID_CAMPEONATO, ID_TIME, ID_ROUND, ID_TABELA_JOGO_NEXT_MATCH, ID_TABELA_JOGO_PREV_MATCH, ID_TIME_NEXT_MATCH, NM_TIME_NEXT_MATCH, DS_MATCTH_1)
		(SELECT pIdUsu, J.ID_CAMPEONATO, _idTime, 0, J.ID_TABELA_JOGO, 0, IF (J.ID_TIME_CASA = _idTime, J.ID_TIME_VISITANTE, J.ID_TIME_CASA), 
		...
		INSERT INTO TB_TEMP_MATCHES_DETAILS_BY_TEAM (ID_USUARIO, ID_CAMPEONATO, ID_TIME, ID_ROUND, ID_TABELA_JOGO_NEXT_MATCH, ID_TABELA_JOGO_PREV_MATCH, DS_MATCTH_1, DS_MATCTH_2, DS_MATCTH_3, DS_MATCTH_4, STATUS_MATCTH)
		(SELECT pIdUsu, J.ID_CAMPEONATO, _idTime, @curRow := @curRow + 1 AS "ID_ROUND", 0, J.ID_TABELA_JOGO, 
